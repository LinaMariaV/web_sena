...
import grindelwald from "../../assets/grindelwald.jpg";
  ...
  return (
    <div className="Destinations">
      ...
      <div className="    Cards-container">
        <CardI image={newyork} title="NEW YORK" text="" button="Ver detalles" />
        <CardI
          image={medellin}
          title="MEDELLIN"
          text=""
          button="Ver detalles"
        />
        <CardI image={bogota} title="BOGOTA" text="" button="Ver detalles" />
      </div>
      <div className="Cards-container">
        <CardI image={bali} title="BALÍ" text="" button="Ver detalles" />
      ...
      <div className="    Cards-container">
        <CardI image={grecia} title="GRECIA" text="" button="Ver detalles" />
        <CardI image={cali} title="CALI" text="" button="Ver detalles" />
        <CardI
          image={barranquilla}
          title="BARRANQUILLA"
          text=""
